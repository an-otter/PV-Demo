...
st.write("---")
st.subheader(f"🔌 In der {spitze:.0f} kWh Spitzenstunde steckt genug Energie für …")
...
# Tag
st.write("---")
st.subheader(f"🔌 Und was bringen dann die {tagesertrag:.0f} kWh des Tages insgesamt?")
